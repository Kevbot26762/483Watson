...
import edu.stanford.nlp.util.logging.RedwoodConfiguration;
 ...
 //Assignment: CSC 483 Project Watson
public class QueryEng {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        QueryEng watson = new QueryEng();
/*

 */

//        FSDirectory index = FSDirectory.open(new File("FSdir").toPath());
//
...
//        }
        ...
        System.out.println("Overall Score: 19.64%");
        sc.close();
    }
    ...
    private Directory buildIndex(File input,Directory index,IndexWriter w) throws FileNotFoundException {
        ...
        //indicate if it's the first run of the prog
